...
//
// Create Date: 07/29/2013 13:13:59
// Design Name: 
// Module Name: CORE_REQUESTS
// Project Name: 
// Target Devices: 
// Tool Versions: 
// Description: 
...
localparam msg_queue_size_p = `ifdef MESSAGE_SYSTEM `MESSAGE_SYSTEM_QUEUE_SIZE; `else 1; `endif
...
localparam synth_function = `ifdef MESSAGE_SYSTEM `SYNTH_FUNCTION; `else 4'b0; `endif
localparam synth2_function = `ifdef MESSAGE_SYSTEM `SYNTH2_FUNCTION; `else 4'b0; `endif
